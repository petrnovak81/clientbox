...
<head>
    ...
    <script src="~/Scripts/mobile/jquery.speechtotext.min.js"></script>
...
<body>
    <div id="login" data-role="view" data-title="Přihlášení">
